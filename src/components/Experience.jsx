...
const Experience = () => {
  const events = [
    ...
    },
    {
      ...
      desc: '4th year IT student. Successfully completed academic Capstone Research developing **StreetSmart**, a web-based educational safety game designed to teach children navigation and street caution.',
      tech: ['Capstone Research', 'Relational DBs', 'Algorithms', 'Game Development'],
      highlights: ['Researched road safety matrices for children', 'Developed interactive path decision vectors', 'Lead system designer & developer']
    },
    {
      type: 'education',
      date: '2020 - 2022',
    ...
    <section id="experience" className="relative py-24 border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical central tracer beam */}
          <div className="absolute left-4 sm:left-1/2 top-2 bottom-2 w-[2px] bg-gradient-to-b from-neon-cyan via-neon-violet to-neon-fuchsia opacity-20" />
            ...
            {events.map((event, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 sm:left-1/2 -translate-x-[15px] sm:-translate-x-1/2 w-8 h-8 rounded-full border-[3px] border-[#030014] bg-dark-card flex items-center justify-center z-10 shadow-lg">
                    {event.type === 'work' ? (
                  ...
                  <div className="w-full sm:w-1/2 pl-12 sm:pl-0 sm:px-8">
                    <div className="glass-panel p-6 rounded-2xl border border-white/5 hover:border-white/10 shadow-xl relative group select-none">
                      ...
                      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-4">
                        {event.tech.map((badge) => (
                          <span
                            key={badge}
                            className="px-2 py-0.5 rounded bg-white/5 text-[9px] sm:text-[10px] text-gray-500 font-mono"
                          >
                            {badge}
                          </span>
                        ))}
